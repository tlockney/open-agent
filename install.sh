...
echo "─────────────────────────────────────────────────"
echo ""
echo "Remote scripts (ropen, open-agent-hook.sh) are managed"
echo "via yadm dotfiles and deployed automatically."
echo ""
echo "Install socat on the remote (recommended):"
echo "   brew install socat"
echo ""
echo "Reconnect SSH and test:"
